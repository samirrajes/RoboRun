...
import { setupCameraToggleListener, updateCamera, setupSkybox } from './commonSetup.js';
import { Box, boxCollision, updatePlayer } from './gameUtils.js';
import { showGameOverScreen, showWinScreen } from './gameOverlays.js';
...
export function createLevel1({ scene, camera, controls, renderer, keys}) {
    ...
    // setup skybox
    setupSkybox(scene, ['./assets/skybox_blizzard/blizzard_ft.jpg',
                        './assets/skybox_blizzard/blizzard_bk.jpg',
                        './assets/skybox_blizzard/blizzard_up.jpg',
                        './assets/skybox_blizzard/blizzard_dn.jpg',
                        './assets/skybox_blizzard/blizzard_rt.jpg',
                        './assets/skybox_blizzard/blizzard_lf.jpg']);
    ...
    characterloader.load('/assets/robot.glb', (gltf) => {
    ...
    const squareGroundTexture = textureLoader.load('./assets/ice_texture.png', undefined, undefined, (error) => {
    ...
    const wideGroundTexture = textureLoader.load('./assets/ice_texture.png', undefined, undefined, (error) => {
        console.error('Error loading texture:', error);
    });
    ...
    const longGroundTexture = textureLoader.load('./assets/ice_texture.png', undefined, undefined, (error) => {
        console.error('Error loading texture:', error);
    });
