...
import { Box, boxCollision, groundCollision, updatePlayer } from './gameUtils.js';
...
export function createLevel2({ scene, camera, controls, renderer, keys }) {
    ...
    //setup skybox
    setupSkybox(scene, ['./assets/skybox_cocoa/cocoa_ft.jpg',
                        './assets/skybox_cocoa/cocoa_bk.jpg',
                        './assets/skybox_cocoa/cocoa_up.jpg',
                        './assets/skybox_cocoa/cocoa_dn.jpg',
                        './assets/skybox_cocoa/cocoa_rt.jpg',
                        './assets/skybox_cocoa/cocoa_lf.jpg']);
    ...
    const groundTexture = textureLoader.load('./assets/cobble_texture.png');
    const lavaTexture = textureLoader.load('./assets/lava_texture.jpg');
